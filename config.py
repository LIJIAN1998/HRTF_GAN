...
class Config:
    ...
    def __init__(self, tag, using_hpc, dataset=None, existing_model_tag=None, data_dir=None):
        ...
        self.hrtf_size = 16
        self.upscale_factor = 108  # can only take values: 2, 4 ,8, 16
        ...
        if using_hpc:
            ...
            # local data dirs
            self.data_dirs_path = '/vol/bitbucket/jl2622/HRTF-results'
        ...
        self.mean_std_coef_dir = self.data_dirs_path + self.data_dir + '/coef_mean_std'
